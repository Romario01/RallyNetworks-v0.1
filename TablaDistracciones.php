...
<table class="container table table-bordered " >
  <thead>
    <tr style="color:white">
      <th class="purple darken-3" scope="col">Nombre de Equipo</th>
      <th class="red darken-3" scope="col">Numero de <br>SANCIONES (-5ptos)</th>
      <th class="cyan darken-4"  scope="col">Dis 1</th>
      <th class="cyan darken-4"  scope="col">Dis 2</th>
      <th class="light-blue darken-4" scope="col">Dis 3</th>
      <th class="light-blue darken-4" scope="col">Dis 4</th>
      <th class="cyan darken-4"  scope="col">Dis 5</th>
      <th class="cyan darken-4"  scope="col">Dis 6</th>
      <th class="light-blue darken-4" scope="col">Dis 7</th>
      <th class="cyan darken-4"  scope="col">Dis 8</th>
      <th class="cyan darken-4"  scope="col">Dis 9</th>
      <th class="light-blue darken-4" scope="col">Dis 10</th>
    </tr>
  </thead>
  <tbody>
    <tr>
    ...
    <th scope="row">"Nombre equipo"</th>
      ...
      <td class="">
        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="B10-70"  >
...
<div class="custom-control custom-checkbox">
      ...
      <td class=" ">
        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="B10-40" >
...
<p>Se desabilitara una vez que se concluya el tiempo total de juego </p>
<h6 style="padding-left: 20%; color: darkblue;">Restan:</h6>
          <h6 id="crono" style="padding-left: 20%; color: crimson;">02hr:04min:56s</h6>
<button type="button" class="btn btn-success" disabled>Capturar Datos</button>
<br><br>
</div>